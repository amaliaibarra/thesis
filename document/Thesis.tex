...
\title{Módulo fabric-contract-api para implementar contratos inteligentes empleando $C\sharp$.}
\author{\\\vspace{0.25cm}Amalia Nilda Ibarra Rodríguez}
\advisor{\\\vspace{0.25cm}Ing. Daniel Frías \\\vspace{0.25cm}Ing. Camilo  Mena\\\vspace{0.2cm}Dr. Miguel Katrib Mora}
